            ...
            <div className="row">
                ...
                <div className="col-md-4">
                   ...
                   <div className="touch">
                       ...
                       <p>+440 455369001- <span className="text-secondary">Fax</span></p>
                       <h5>Email Address:</h5>
                ...
                <div className="col-md-4">
                   <h2>Email Newsletters</h2>
                    <input className='p-2' type="email" placeholder='Email'/><br/>
                    <input className='p-2' type="password" placeholder='password' /><br/><br/>
                    <button className='btn btn-danger'>Subscribe Now</button>
                </div>
            </div>
           <p className='text-danger'> &copy; 2021 Medical Center Globals Doctor's clinic</p>
        </div>
    );
};
